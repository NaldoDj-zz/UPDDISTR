...
@echo off
	...
	if exist .\sdfbra.bat (
		attrib .\sdfbra.bat +r /s /d
    )

	if exist .\sdfbrajob.bat (
		attrib .\sdfbrajob.bat +r /s /d
    )

	if exist .\upddistr_param.json (
		attrib .\upddistr_param.json +r /s /d
    )
